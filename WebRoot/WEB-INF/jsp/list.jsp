...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form action="MessageList.action" id="mainForm" method="post">
			<div class="right">
					...
					<div class="zixun fix">
						<table class="tab2" width="100%">
							<tbody>
								...
								<c:forEach items="${messageList}" var="message" varStatus="a">
				                          <tr <c:if test="${a.index%2!=0}">style='background-color:#ECF6EE;'</c:if>>
